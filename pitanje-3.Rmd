...
```{r}
dataset_pit3 <- read_csv("preprocessed_data.csv")
```
...
plot(dataset_pit3$BedroomAbvGr, dataset_pit3$ppsqm, col='#453F78', xlab='Broj spavaćih soba u nekretnini', ylab='Cijena po kvadratu', main = 'Cijena kvadrata nekretnine')
```
...
plot(dataset1$BedroomAbvGr,dataset1$ppsqm,col='#453F78', xlab='Broj spavaćih soba u nekretnini', ylab='Cijena po kvadratu', main = 'Cijena kvadrata nekretnine')
boxplot(dataset1$ppsqm ~ dataset1$BedroomAbvGr,  col='#453F78', xlab='Broj spavaćih soba u nekretnini', ylab='Cijena po kvadratu', main = 'Cijena kvadrata nekretnine')
qqnorm(dataset1$ppsqm, col='#453F78', ylab='Cijena po kvadratu', xlab='Teoretski kvantili', main = 'Cijena kvadrata nekretnine -- Q-Q Plot')
qqline(dataset1$ppsqm)
hist(dataset1$ppsqm,  col='#453F78', xlab='Broj spavaćih soba u nekretnini', ylab='Frekvencija', main = 'Cijena kvadrata nekretnine', border='white')
```
...
plot(no_outliers$BedroomAbvGr, no_outliers$ppsqm,  col='#453F78', xlab='Broj spavaćih soba u nekretnini', ylab='Cijena po kvadratu', main = 'Cijena kvadrata nekretnine - bez outliera')

qqnorm(no_outliers$ppsqm,  col='#453F78', xlab='Teoretski kvantili', ylab='Cijena po kvadratu', main = 'Cijena kvadrata nekretnine - bez outliera - Q-Q Plot')
qqline(no_outliers$ppsqm)
hist(no_outliers$ppsqm,  col='#453F78', xlab='Cijena po kvadratu', ylab='Frekvencija', main = 'Cijena kvadrata nekretnine - bez outliera - histogram', border='white')
```
...
plot(data1to4$ppsqm ~ data1to4$BedroomAbvGr, col='#453F78', xlab='Broj spavaćih soba u nekretnini', ylab='Cijena po kvadratu', main = 'Cijena kvadrata nekretnine - bez outliera - velike kategorije')

hist(data1to4$ppsqm[data1to4$BedroomAbvGr == 1], breaks = 12, col='#453F78', xlab='Cijena kvadrata', ylab='Frekvencija', main = 'Cijena kvadrata nekretnine - 1 sobni - histogram', border='white')
hist(data1to4$ppsqm[data1to4$BedroomAbvGr == 2],  col='#453F78', xlab='Cijena kvadrata', ylab='Frekvencija', main = 'Cijena kvadrata nekretnine - 2 sobni - histogram', border='white')
hist(data1to4$ppsqm[data1to4$BedroomAbvGr == 3],  col='#453F78', xlab='Cijena kvadrata', ylab='Frekvencija', main = 'Cijena kvadrata nekretnine - 3 sobni - histogram', border='white')
hist(data1to4$ppsqm[data1to4$BedroomAbvGr == 4], breaks = 20,  col='#453F78', xlab='Cijena kvadrata', ylab='Frekvencija', main = 'Cijena kvadrata nekretnine - 4 sobni - histogram', border='white')
```
```{r}
require(nortest)
...
```{r}
boxplot(ppsqm ~ BedroomAbvGr,data=data1to4, col='#453F78', xlab='Broj spavaćih soba u nekretnini', ylab='Cijena po kvadratu', main = 'Cijena kvadrata nekretnine - 1 do 4-sobne nekretnine')
```
