...
var(data1to4$ppsqm[data1to4$BedroomAbvGr == 1])
var(data1to4$ppsqm[data1to4$BedroomAbvGr == 2])
var(data1to4$ppsqm[data1to4$BedroomAbvGr == 3])
var(data1to4$ppsqm[data1to4$BedroomAbvGr == 4])
