...
unique_neighbourhood <- unique(neighbourhood)
```
Postoji 25 različitih kvartova za koje ispitujemo ako utječu na veličinu podruma

# ANOVA

Koristit ćemo statistički test ANOVA kako bi testirali sredinu više populacija. U našem slučaju imamo 25 kvartova gdje ćemo za svaki kvart izračunati sredjnu veličine garaže. 
