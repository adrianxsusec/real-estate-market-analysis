...
hist(dataset_pit2$TotalBsmtSF, breaks = 20, main="Veličine podruma nekretnina",xlab="Veličina podruma",
     ylab="Frekvencije", col="#69b3a2", border="white")
...
boxplot(dataset_pit2$TotalBsmtSF ~ dataset_pit2$Neighborhood, col="#69b3a2", xlab = "Kvartovi", ylab="Površina podruma", las=3)
