...
H0: broj katova kuće ne ovisi o obliku zemljišne čestice
...
df <- df[,c('HouseStyle', 'LotShape')]

barplot(table(df$LotShape))

barplot(table(df$HouseStyle))
...
Prethodno spomenute hipoteze testiramo testom nezavisnoti pomoću chi^2 testa.
```{r}
