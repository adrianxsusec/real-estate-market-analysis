...
Grupiramo vrijednosti podataka u stupcu. Stambeni objekti koji imaju 1.5 kat tretiramo kao da imaju 1 kat, a objekti koji imaju 2.5 kata tretiramo kao da imaju 2 kata. 
```{r}
...
chisq.test(df$LotShape, df$HouseStyle, simulate.p.value = TRUE, B = 20000)
